...
export declare class AgentRolesService {
    ...
    generateFromDescription(userId: string, organizationId: string, description: string): Promise<{
        builtin: boolean;
        organizationId: string;
        slug: string;
        name: string;
    ...
    createManual(userId: string, organizationId: string, dto: CreateAgentRoleDto): Promise<{
        builtin: boolean;
        organizationId: string;
        slug: string;
        name: string;
